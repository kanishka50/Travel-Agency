...
<head>
    ...
    <title>Send Proposal - {{ $plan->title }}</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-6">
            <a href="{{ route('plans.show', $plan->id) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center">
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6">
                ...
                <p class="text-blue-100 mt-1">{{ $plan->title }}</p>
            ...
            <form action="{{ route('proposals.store', $plan->id) }}" method="POST" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div id="selected-dates" class="hidden bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
                            <p class="text-sm font-semibold text-blue-900">Selected Dates:</p>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="num_adults" id="num_adults" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <select name="num_children" id="num_children" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                @for($i = 0; $i <= 5; $i++)
                ...
                <div>
                    ...
                    <div>
                        ...
                        <textarea name="modifications" id="modifications" rows="4"
                                  ...
                                  class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('modifications') }}</textarea>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <textarea name="message" id="message" rows="3"
                                  ...
                                  class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('message') }}</textarea>
                        @error('message')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <button type="submit" id="submit-btn" disabled
                            class="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-lg transition-colors">
                        Submit Proposal
                    </button>
                </div>
            </form>
