...
<head>
    ...
    <title>Custom Tour Booking Agreement - {{ $booking->booking_number }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="header">
        ...
        <p>Custom Tour Booking Agreement <span class="custom-badge">From Tourist Request</span></p>
    </div>
    ...
    <div class="booking-info">
        ...
        <div class="info-row">
            ...
            <div class="info-value">Custom Request</div>
        </div>
        <div class="info-row">
    ...
    <div class="section">
        ...
        <div class="info-row">
            ...
            <div class="info-value"><strong>{{ $touristRequest->title }}</strong></div>
        </div>
        <div class="info-row">
            <div class="info-label">Destinations:</div>
            <div class="info-value">{{ is_array($touristRequest->preferred_destinations) ? implode(', ', $touristRequest->preferred_destinations) : $touristRequest->preferred_destinations }}</div>
        </div>
        @if($touristRequest->must_visit_places)
        <div class="info-row">
            <div class="info-label">Must Visit:</div>
            <div class="info-value">{{ $touristRequest->must_visit_places }}</div>
        </div>
        @endif
        <div class="info-row">
            <div class="info-label">Trip Focus:</div>
            <div class="info-value">{{ is_array($touristRequest->trip_focus) ? implode(', ', $touristRequest->trip_focus) : $touristRequest->trip_focus }}</div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="info-row">
            ...
            <div class="info-value">{{ is_array($booking->children_ages) ? implode(', ', $booking->children_ages) : $booking->children_ages }} years old</div>
        </div>
        @endif
    ...
    @if($bid->day_by_day_plan)
    <div class="section">
        <h3>Guide's Proposed Itinerary</h3>
        <div class="itinerary">
            <h4>Day-by-Day Plan</h4>
            {!! nl2br(e($bid->day_by_day_plan)) !!}
        </div>
    </div>
    @endif

    @if($bid->proposal_message)
    <div class="section">
        <h3>Guide's Proposal</h3>
        <p>{{ $bid->proposal_message }}</p>
    </div>
    @endif
    ...
    <div class="section">
        ...
        <table class="pricing-table">
            ...
            <tbody>
                <tr>
                    <td>Custom Tour Package ({{ $booking->num_adults }} {{ Str::plural('Adult', $booking->num_adults) }}
    ...
    <div class="section">
        <div class="terms">
            ...
            <ul>
                <li>This is a custom tour booking based on a tourist's specific request and a guide's accepted proposal.</li>
                ...
                <li>The guide agrees to provide services as outlined in the proposed itinerary.</li>
                ...
                <li>The guide reserves the right to cancel due to unforeseen circumstances; a full refund will be provided.</li>
                <li>Both parties agree to communicate respectfully and professionally throughout the tour.</li>
                <li>The platform acts as an intermediary and is not responsible for the quality of services provided.</li>
                ...
                <li>Any modifications to the itinerary must be agreed upon by both parties.</li>
            </ul>
        </div>
    </div>
