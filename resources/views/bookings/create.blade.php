...
<head>
    ...
    <title>Book Tour - {{ $plan->title }}</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <p class="text-gray-600">You're booking: <span class="font-semibold">{{ $plan->title }}</span></p>
        ...
        <div x-data="{
            ...
            <div class="border-b border-gray-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <div :class="currentStep >= 1 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600'"
                    ...
                    <div class="flex items-center space-x-2">
                        <div :class="currentStep >= 2 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600'"
                    ...
                    <div class="flex items-center space-x-2">
                        <div :class="currentStep >= 3 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600'"
            ...
            <form action="{{ route('bookings.store') }}" method="POST">
                ...
                <div x-show="currentStep === 1" class="p-6 space-y-6">
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 border border-blue-200">
                        ...
                        <div class="space-y-1 text-sm">
                            <div class="flex justify-between">
                                <span class="text-gray-600">Adults (<span x-text="numAdults"></span> × $<span x-text="pricePerAdult.toFixed(2)"></span>):</span>
                            ...
                            <div class="flex justify-between" x-show="numChildren > 0">
                                <span class="text-gray-600">Children (<span x-text="numChildren"></span> × $<span x-text="pricePerChild.toFixed(2)"></span>):</span>
                    ...
                    <div class="flex justify-end">
                        <button type="button"
                                ...
                                :class="canProceedStep1() ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-300 text-gray-500 cursor-not-allowed'"
                ...
                <div x-show="currentStep === 2" class="p-6 space-y-6">
                        ...
                        <div class="space-y-4">
                            @foreach($plan->addons as $addon)
                                <div class="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors"
                                     :class="isAddonSelected({{ $addon['id'] }}) ? 'bg-blue-50 border-blue-300' : 'bg-white'">
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1">
                                            <label class="flex items-center cursor-pointer">
                                                <input type="checkbox"
                                                       @change="toggleAddon({{ $addon['id'] }}, '{{ addslashes($addon['name']) }}', {{ $addon['price'] }})"
                                        ...
                                        <div class="ml-4 text-right">
                                            <p class="font-semibold text-gray-900">${{ number_format($addon['price'], 2) }}</p>
                                    ...
                                    <div x-show="isAddonSelected({{ $addon['id'] }})" class="mt-3 flex items-center space-x-3">
                                        ...
                                        <input type="hidden"
                                               ...
                                               value="{{ addslashes($addon['name']) }}">
                                        <input type="hidden"
                                               :name="'selected_addons[' + selectedAddons.findIndex(a => a.addon_id === {{ $addon['id'] }}) + '][price]'"
                                               :value="{{ $addon['price'] }}">
                                        <span class="text-sm text-gray-600">
                                            Total: $<span x-text="(getAddon({{ $addon['id'] }}).quantity * {{ $addon['price'] }}).toFixed(2)"></span>
                                        </span>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    <!-- Add-ons Total -->
                    <div class="bg-blue-50 rounded-lg p-4 border border-blue-200" x-show="selectedAddons.length > 0">
                ...
                <div x-show="currentStep === 3" class="p-6 space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 space-y-2" x-show="selectedAddons.length > 0">
                        ...
                        <template x-for="addon in selectedAddons" :key="addon.addon_id">
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-600"><span x-text="addon.name"></span> (×<span x-text="addon.quantity"></span>)</span>
                    ...
                    <div class="bg-blue-50 rounded-lg p-6 border-2 border-blue-200 space-y-3">
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <div class="border-t-2 border-blue-300 pt-2 mt-2">
                                <div class="flex justify-between text-lg font-bold text-gray-900">
                                    ...
                                    <span class="text-blue-600">$<span x-text="totalAmount.toFixed(2)"></span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                        ...
                        <button type="submit"
                                class="px-8 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold text-lg transition-colors shadow-lg hover:shadow-xl">
                            Confirm Booking
                        </button>
                    </div>
