                    ...
                    @foreach($plans as $plan)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    @if($plan->cover_photo)
                                        <img class="h-10 w-10 rounded object-cover" src="{{ Storage::url($plan->cover_photo) }}" alt="{{ $plan->title }}">
                                    @else
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $plan->num_days }} days / {{ $plan->num_nights }} nights</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">${{ number_format($plan->price_per_adult, 2) }}</div>
