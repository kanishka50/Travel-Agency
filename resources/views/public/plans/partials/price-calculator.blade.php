        ...
        @auth
            @if(auth()->user()->tourist)
                <a href="{{ route('proposals.create', $plan->id) }}"
                   class="block w-full py-3 bg-green-600 text-white text-center font-semibold rounded-lg hover:bg-green-700 transition mb-3">
            ...
            @endif
        @else
            <a href="{{ route('login') }}" class="block w-full py-3 bg-green-600 text-white text-center font-semibold rounded-lg hover:bg-green-700 transition mb-3">
