...
<div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300">
    <a href="{{ route('plans.show', $plan->id) }}" class="block">
        ...
        <div class="p-4">
            ...
            <!-- Guide Info -->
            <div class="flex items-center text-sm text-gray-600 mb-3 pb-3 border-b">
                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center justify-between">
                ...
                <span class="px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition">
                    View Details
                </span>
            </div>
            ...
            <div class="flex items-center justify-between mt-3 pt-3 border-t text-xs text-gray-500">
                ...
                <span>{{ $plan->booking_count }} bookings</span>
            </div>
        </div>
    </a>
</div>
