            ...
            <form method="POST" action="{{ route('tourist.register') }}" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input id="full_name" type="text" name="full_name" value="{{ old('full_name') }}" required autofocus
                                   class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors @error('full_name') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email') }}" required
                                   class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors @error('email') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <input id="phone" type="tel" name="phone" value="{{ old('phone') }}" required
                                   class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors @error('phone') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <input id="country" type="text" name="country" value="{{ old('country') }}" required
                                   class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors @error('country') border-red-500 @enderror"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input id="password" type="password" name="password" required
                                   class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors @error('password') border-red-500 @enderror"
                ...
                <div class="text-center pt-2">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('guide.register') }}" class="font-semibold text-teal-600 hover:text-teal-700">
                            Register as a Guide
                        </a>
                    </p>
                </div>
