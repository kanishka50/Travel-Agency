        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div class="text-center mb-6">
                    ...
                    <p class="text-gray-600 mt-2 text-sm">No problem! Just enter your email address and we'll send you a password reset link.</p>
                </div>
                ...
                @if (session('status'))
                    <div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                        <div class="flex">
                            ...
                            <p class="ml-3 text-sm text-green-800">{{ session('status') }}</p>
                        </div>
                    </div>
                @endif
