...
<div class="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
                    ...
                    @if($booking->booking_type === 'custom_request' && $booking->touristRequest)
                        ...
                        @if($booking->acceptedBid && $booking->acceptedBid->day_by_day_plan)
                            <div class="pt-4 border-t border-gray-200">
                                <span class="text-sm text-gray-500 font-medium">Guide's Proposed Itinerary</span>
                        ...
                        <div class="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900">{{ $duration }} {{ Str::plural('day', $duration) }}</p>
                            </div>
                            <div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <span class="inline-block px-2 py-1 bg-emerald-100 text-emerald-700 text-xs font-medium rounded-full mb-1">{{ $booking->guide->guide_type_label }}</span>
            ...
            <!-- Vehicle Information (Only show for confirmed/upcoming bookings) -->
            @if(in_array($booking->status, ['confirmed', 'ongoing', 'completed']))
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h2 class="text-xl font-semibold text-gray-900 mb-4">Tour Vehicle</h2>
                    ...
                    @if($booking->vehicleAssignment)
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            @else
                                <div class="w-28 h-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center shadow-sm">
                            ...
                            <div class="flex-1">
                                <h3 class="font-semibold text-lg text-gray-900">{{ $assignment->vehicle_display_name }}</h3>
                                ...
                                @if(!empty($vehicleDetails['description']))
                                    <p class="text-sm text-gray-600 mt-3">{{ $vehicleDetails['description'] }}</p>
                                @endif
                    ...
                    @else
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="font-medium text-blue-800">Vehicle Being Arranged</p>
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between text-lg font-bold pt-3 border-t-2 border-gray-300">
                        ...
                        <span class="text-emerald-600">${{ number_format($booking->total_amount, 2) }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                @elseif($booking->status === 'payment_failed')
                    ...
                    <form action="{{ route('payment.checkout', $booking->id) }}" method="POST">
                        @csrf
                        <button type="submit" class="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-3 rounded-lg transition-colors shadow-md hover:shadow-lg flex items-center justify-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="space-y-2">
                    <a href="{{ route('tourist.bookings.index') }}" class="block w-full text-center bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-2 rounded-lg transition-colors">
                        View All Bookings
                    </a>
                    @if($booking->guidePlan)
                        <a href="{{ route('tour-packages.show', $booking->guidePlan->id) }}" class="block w-full text-center bg-emerald-100 hover:bg-emerald-200 text-emerald-700 font-semibold py-2 rounded-lg transition-colors">
                            View Tour Details
                        </a>
                    @elseif($booking->touristRequest)
                        <a href="{{ route('tourist.requests.show', $booking->touristRequest->id) }}" class="block w-full text-center bg-purple-100 hover:bg-purple-200 text-purple-700 font-semibold py-2 rounded-lg transition-colors">
    ...
    <div class="mt-8 text-center">
        <a href="{{ route('tourist.bookings.index') }}" class="text-emerald-600 hover:text-emerald-800 font-semibold">
