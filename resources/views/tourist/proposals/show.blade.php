...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <!-- Header -->
    <div class="mb-6">
        <a href="{{ route('tourist.proposals.index') }}" class="text-emerald-600 hover:text-emerald-800 text-sm font-medium flex items-center">
        ...
        <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-emerald-100 mt-1">Proposal submitted {{ $proposal->created_at->format('M d, Y') }}</p>
                </div>
                ...
                <div class="flex items-start space-x-4">
                    ...
                    @else
                        <div class="w-16 h-16 rounded-full bg-emerald-100 flex items-center justify-center">
                            <span class="text-emerald-600 text-xl font-bold">{{ substr($proposal->guidePlan->guide->full_name, 0, 1) }}</span>
                        </div>
                    @endif
                    <div class="flex-1">
