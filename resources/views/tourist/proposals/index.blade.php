        ...
        <div class="border-b border-gray-200">
            <nav class="flex space-x-8 px-6" aria-label="Tabs">
                ...
                <a href="{{ route('tourist.proposals.index', ['status' => 'pending']) }}"
                   class="border-b-2 {{ request('status') === 'pending' ? 'border-emerald-600 text-emerald-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} py-4 px-1 text-sm font-semibold">
                    Pending
                </a>
