...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <!-- Header -->
    <div class="mb-8">
        <a href="{{ route('tourist.requests.index') }}" class="text-emerald-600 hover:text-emerald-700 flex items-center mb-4">
            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
            </svg>
            Back to My Requests
        </a>
        <h1 class="text-3xl font-bold text-gray-900">Request a Custom Tour</h1>
        <p class="mt-2 text-gray-600">Tell us what you want, and guides will submit their best proposals</p>
    </div>
    ...
    <div x-data="{
        ...
        <form action="{{ route('tourist.requests.store') }}" method="POST" class="bg-white rounded-lg shadow-sm p-6">
            @csrf
            ...
            <div x-show="step === 4" x-transition>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
                        <h3 class="text-sm font-semibold text-emerald-900 mb-2">What happens next?</h3>
                        <ul class="text-sm text-emerald-800 space-y-1">
                            <li>Your request will be visible to verified guides</li>
                            <li>Guides can submit up to 2 proposals each</li>
                            <li>You'll receive email notifications when guides bid</li>
                            <li>Request expires automatically after 14 days</li>
                            <li>You can compare proposals and choose the best one</li>
                        </ul>
                    </div>
                </div>
