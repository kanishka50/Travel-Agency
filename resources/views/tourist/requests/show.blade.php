...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="{{ route('tourist.requests.index') }}" class="text-emerald-600 hover:text-emerald-700 flex items-center">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 hover:border-emerald-300 transition-colors">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    ...
                                    <p class="text-2xl font-bold text-emerald-600 mb-2">${{ number_format($bid->total_price, 2) }}</p>
                                ...
                                <div class="ml-4">
                                    <a href="{{ route('tourist.bids.show', [$touristRequest, $bid]) }}" class="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 text-sm font-medium inline-block">
                                        View Proposal
                                    </a>
                                </div>
                            </div>
