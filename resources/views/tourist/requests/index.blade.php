...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('tourist.requests.create') }}"
           class="px-6 py-3 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 font-semibold shadow-md hover:shadow-lg transition-all">
            + New Request
        </a>
    </div>
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-3 text-sm">
                            <span class="text-emerald-600 font-medium">{{ $request->bid_count }} {{ Str::plural('proposal', $request->bid_count) }} received</span>
                        </div>
                        @endif
                    ...
                    <div class="mt-4 lg:mt-0 lg:ml-6 flex flex-col gap-2">
                        <a href="{{ route('tourist.requests.show', $request->id) }}"
                           class="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 text-center font-medium transition-colors">
                            View Details
                        </a>
    ...
    @else
        ...
        <div class="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <a href="{{ route('tourist.requests.create') }}"
               class="mt-6 inline-block px-6 py-3 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 font-semibold shadow-md hover:shadow-lg transition-all">
