...
<head>
    ...
    <title>Request Custom Tour - Travel Agency</title>
            ...
            <form action="{{ route('tourist-requests.store') }}" method="POST" class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div x-show="step === 4" x-transition>
                    ...
                    <div class="mt-6 flex justify-between">
                        ...
                        <button type="submit"
                                class="px-8 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 font-semibold shadow-md hover:shadow-lg transition-all">
                            Submit Request
                        </button>
                    </div>
                </div>
